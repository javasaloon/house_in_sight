...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { description: @apartment.description, image_url: @apartment.image_url, name: @apartment.name, price: @apartment.price }
    end
  ...
  test "should update apartment" do
    put :update, id: @apartment, apartment: { description: @apartment.description, image_url: @apartment.image_url, name: @apartment.name, price: @apartment.price }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
