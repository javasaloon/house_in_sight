...
class GardensControllerTest < ActionController::TestCase
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post :create, garden: { address: @garden.address, feather: @garden.feather, level: @garden.level, name: @garden.name, phone: @garden.phone }
    end
  ...
  test "should update garden" do
    put :update, id: @garden, garden: { address: @garden.address, feather: @garden.feather, level: @garden.level, name: @garden.name, phone: @garden.phone }
    assert_redirected_to garden_path(assigns(:garden))
  end
