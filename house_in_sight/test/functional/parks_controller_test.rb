...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { address: @park.address, name: @park.name, phone: @park.phone, traffic: @park.traffic }
    end
  ...
  test "should update park" do
    put :update, id: @park, park: { address: @park.address, name: @park.name, phone: @park.phone, traffic: @park.traffic }
    assert_redirected_to park_path(assigns(:park))
  end
