...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { address: @hospital.address, feather: @hospital.feather, level: @hospital.level, name: @hospital.name, phone: @hospital.phone }
    end
  ...
  test "should update hospital" do
    put :update, id: @hospital, hospital: { address: @hospital.address, feather: @hospital.feather, level: @hospital.level, name: @hospital.name, phone: @hospital.phone }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
